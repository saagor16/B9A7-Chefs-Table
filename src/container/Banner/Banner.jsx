import backgroundImage from '../../../public/imga/banner.jpg'
        ...
        <div>
          <div  className="bg-no-repeat bg-cover lg:w-full rounded-3xl lg:h-[760px]" style={{backgroundImage: `url(${backgroundImage})`}}>
            <div className='text-center mt-10 space-y-8 text-white lg:p-[200px] md:p-[100px] leading-5'>
                ...
                <p className='pt-2 lg:text-xl '>Join Recipe Calories for an immersive and interactive online cooking experience via Zoom, right from the comfort of your <br /> own home.Cook with  step through easy-to-follow Recipe Calories recipes.</p>
